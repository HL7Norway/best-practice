...
* There is no official position about weather you should adopt it or not.
...
[14:13] Mikael Rinnetmäki

How about IG authors? Multiple versions or one multi-version IG?

[14:33] Mikael Rinnetmäki

We still don't have a really good view on how we should best support multiple versions in parallel. Wider adoption of R5 would give us more experience. Right? 

[14:33] Mikael Rinnetmäki

(Yes, I understand that even that point might not justify the cost.)
...
A good excuse that the developer in me likes very much, but probably not enough to justify the cost, as you say 

[14:35] Mikael Rinnetmäki

For me as a developer of a trivial app it's absolutely not a big problem, even financially, to support all versions.

[14:36] Mikael Rinnetmäki

For me as an IG author, the problem seems to be there...

[14:36] Ingvar Sørlien

Do you see a chance that R4 actually will be a "perpetual" version of FHIR with backports? Like DICOM never progresses from 3.0.
...
Adam: Wouldn't that mean the end of FHIR though? Then in 10 years Standard X comes along and replaces FHIR. So to prevent that it it still important to improve FHIR, even if not all versions are implemented.

* 5 + 5 + 5 - something better would come along (after 15 years)
* REST, API, JSON - FHIR is relatively heavy
* Far more important than tech and community - FHIR works because of the large and enthusiastic community
  * FHIR is better because of the community, nothing coming at the moment
  * Not what I imagined
...
* Head to head in clinical data repo space
* OpenEHR more about internal data repo than interoperability

Ø: FHIR by it's interop capability taking over more from OpenEHR
...
Ø: Developing FHIR valueset from working with OpenEHR community
