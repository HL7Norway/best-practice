...
5. Utgikk grunnet sykdom: Oppdaterte anbefalinger om SMART on FHIR, Frank Bråthen (Helsedirektoratet), 20 min
...
* [NAVs erfaringer med SMART on FHIR](../docs/FHIR-faglig-forum/presentasjon/2026-02-11-Navs-erfaringer-med-SMART-on-FHIR.pdf)
* [SMART on FHIR i HSØ](../docs/FHIR-faglig-forum/presentasjon/2026-02-11-SMART-on-FHIR-HSO.pdf)
...
* Ta kontakt med HL7 Norge på: [post@hl7.no](post@hl7.no)  
...
* DEMO
![Webmed startbilde](image.png)
* NAV appen i webmed 
![NAV app i Webmed](image-1.png)
...
[Beskrivelse av NAV sine krav til leverandører](https://github.com/navikt/syk-inn/blob/main/docs/fhir/nav_requirements.md)  
[FHIR Ressurser som benyttes i grensesnitt mot NAV](https://github.com/navikt/syk-inn/blob/main/docs/fhir/_oversikt.md)  
[Token veksling mot HelseID](https://utviklerportal.nhn.no/informasjonstjenester/helseid/bruksmoenstre-og-eksempelkode/bruk-av-helseid/docs/teknisk-referanse/token_exchange_enmd)  
