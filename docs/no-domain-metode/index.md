...
Metoden er basert på utviklingsmetoden for HL7 FHIR, Helsedirektoratets [nivåer for normerende produkter](https://www.helsedirektoratet.no/om-oss/om-helsedirektoratets-normerende-produkter) og [profileringshierarkiet for HL7 FHIR  i Norge](https://git.sarepta.ehelse.no/utvikling/FHIR/-/wikis/profilering). Utviklingen av områdeprofiler utføres av aktører i sektoren og normeringen av områdeprofilene utføres i henhold til Helsedirektoratets forvaltningsmodell.
